...
import { DiscoverList } from '@/utils/datafake';

export default function SectionStackBanner() {
                        ...
                        {DiscoverList &&
                            DiscoverList.map((item, index) => (
                                <div key={index} className="banner__slider-item">
                                    <div className="banner__slider-content" style={{ backgroundColor: item.color }}>
